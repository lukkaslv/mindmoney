...
export const ResultsView = memo<ResultsViewProps>(({ 
  ...
  const isRedFlag = result.systemHealth < 25 || result.state.foundation < 30;
        ...
        <div className="relative z-10 space-y-4">
            <div className="flex justify-between items-center">
              ...
              <div className="flex flex-col items-end">
                  ...
                  <span className={`text-[10px] font-mono font-bold ${result.confidenceScore > 80 ? 'text-emerald-400' : 'text-amber-400'}`}>{result.confidenceScore}%</span>
              </div>
            </div>
